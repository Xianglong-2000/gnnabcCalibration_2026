...
sys.path.append('D:/Projects/GNN Research/Code Files/my_code_files/general')  # for simulation_module.py
...
def model_iter(parameters:dict):
    ...
    print(f"sim params: gamma = {gamma}, alpha = {reg_param}")
    ...
    sim_file = "/work/x5bai/project/Code_Files/s5/"+moduleName
...
def simulate(modfilename, reg_param, gamma, max_cells=None, max_time=None, export_path=None):
    ...
    sim_file = "/work/x5bai/project/Code_Files/s5/"+modfilename
