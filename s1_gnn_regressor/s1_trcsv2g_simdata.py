...
def get_param_dict(parent_dir_tr: str, parent_dir: str):
    ...
    for f in folders:
        ...
        for ff in sub_folders:
            ...
            csv1_pre_path = [f for f in os.listdir(sub_parent_dir_tr + "/" + ff + "/data")][0]
            csv2_pre_path = [f for f in os.listdir(sub_parent_dir + "/" + ff + "/data")][0]
            csv1_path = sub_parent_dir_tr + "/" + ff + "/data/" + csv1_pre_path + "/Trackrefiner.Objects_properties_Average_analysis.csv"  # node features
            csv2_path = sub_parent_dir + "/" + ff + "/data/" + csv2_pre_path + "/Object_relationships.csv"  # neighbours
...
if __name__ == "__main__":
    ...
    parent_dir_tr = "/work/x5bai/project/Data_Files/_sim_tr_csv_data_gnn/2025-11-22"
    parent_dir = "/work/x5bai/project/Data_Files/_sim_csv_data_gnn/2025-11-22"
    ...
    folder_path = "/work/x5bai/project/Data_Files/_sim_mean_std_values_gnn/2025-11-22/"
    os.makedirs(folder_path, exist_ok=True)
    final_path = os.path.join(folder_path, "S1_test_1122.pkl")
    ...
    # save the graph data
    folder_path = "/work/x5bai/project/Data_Files/_sim_graph_data_gnn/2025-11-22/"
    os.makedirs(folder_path, exist_ok=True)
    g_data_path = os.path.join(folder_path, "S1_test_1122.pkl")
