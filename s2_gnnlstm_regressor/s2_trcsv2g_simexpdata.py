...
if __name__ == "__main__":
    ...
    parent_dir = "D:/Projects/GNN Research/Data Files/_sim_mean_std_values_gnn/2025-08-20/"  ### for 31 simulated-experimental data only
    final_path = parent_dir + "CVIS_S2.pkl"  ### for 31 simulated-experimental data only
    ...
    for key in param_dict.keys():
        ...
        g_data_path = os.path.join(folder_path, "CVIS_S2_simexp.pkl")
