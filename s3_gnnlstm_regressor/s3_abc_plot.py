...
def plot_1d(history, limits, exact, key, **kwargs):
    ...
    plt.show()
    plt.savefig("s3_%s_1D_KDE-t=%s.png" % (key,t), bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    param_config = {"gamma": [math.log(0.1), math.log(1000)], "reg_param": [math.log(0.01), math.log(100)]}
    prior_distributions = {}
