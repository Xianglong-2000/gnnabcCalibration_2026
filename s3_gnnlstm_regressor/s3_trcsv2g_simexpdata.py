...
def test1():
    ...
    parent_dir = "D:/Projects/GNN Research/Data Files/_sim_mean_std_values_gnn/2025-09-25/"  ### for 31 simulated-experimental data only
    final_path = parent_dir + "CVIS_S3.pkl"  ### for 31 simulated-experimental data only
    print(final_path)  ### for 31 simulated-experimental data only
    with open(final_path, "rb") as file:  ### for 31 simulated-experimental data only
        values = pk.load(file)  ### for 31 simulated-experimental data only
    print(values)  ### for 31 simulated-experimental data only
    gamma_mean = values["gamma mean"]  ### for 31 simulated-experimental data only
    gamma_std = values["gamma std"]  ### for 31 simulated-experimental data only
    reg_param_mean = values["reg_param mean"]  ### for 31 simulated-experimental data only
    reg_param_std = values["reg_param std"]  ### for 31 simulated-experimental data only
    mean_dict = values["feature mean"]  ### for 31 simulated-experimental data only
    std_dict = values["feature std"]  ### for 31 simulated-experimental data only
    ...
    g_data_path = os.path.join(folder_path, "CVIS_S3_simexp.pkl")
