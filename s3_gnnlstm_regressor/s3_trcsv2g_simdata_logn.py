...
def load_graph_data(graph_ID, node_features_file, neighbours_edge_file, include_columns,
    ...
    y1 = math.log(float(gamma))
    y2 = math.log(float(alpha))
...
def test1():
    ...
    parent_dir = "D:/Projects/GNN Research/Data Files/_sim_tr_csv_data_gnn/2025-09-25 new/"
    ...
    ##for i in [iterations[0]]:  ### for a test only
        ...
        folder_name = [f for f in os.listdir(f"{i}/{sub_folder_name}/data")][0]

        csv_path_1 = f"{i}/{sub_folder_name}/data/{folder_name}/Trackrefiner.FilterObjects_Average_analysis.csv"
        csv_path_2 = f"{i}/{sub_folder_name}/data/{folder_name}/Trackrefiner.FilterObjects_Average_neighbors.csv"
    ...
    folder_path = "D:/Projects/GNN Research/Data Files/_sim_mean_std_values_gnn/2025-09-25/"
    os.makedirs(folder_path, exist_ok=True)
    final_path = os.path.join(folder_path, "S3_test_1108_meanstd.pkl")
    ...
    # save graphs
    folder_path = "D:/Projects/GNN Research/Data Files/_sim_graph_data_gnn/2025-09-25/"
    os.makedirs(folder_path, exist_ok=True)
    g_data_path = os.path.join(folder_path, "S3_test_1108.pkl")
